  ...
  render: _self =>
    <section>
      ...
      <main>
        (
          {js|
DemoConf is the **world's first** conference for [ReasonML](https://reasonml.github.io), a new language on top of OCaml
...
DemoConf is a **not-for-profit** conference. [The goal of the
